...
\begin{tikzpicture}[x=0.25cm,y=0.25cm]
	...
	\node[assembly,fill=gray!50] (b5) at (5.5,9) {};
	\node[align=left] (b5t) at (12.5,9) {Block $2$};
	\foreach \x in {0,...,7}
	\foreach \y in {0,...,11}
	{\fill (\x,\y) circle (2pt);}
	\draw (b1) -- (b1t);
	...
	\begin{scope}[xshift=-3.25cm,yshift=4.25cm]
		...
		\draw[<->,ultra thick,dotted] (b4) -- (b4n);
	\end{scope}
	\begin{scope}[xshift=0cm,yshift=4.25cm]
		...
		\node[assembly,fill=gray!50] (b5n) at (5.5,9) {};
		\foreach \x in {0,...,7}
		\foreach \y in {0,...,11}
		{\fill (\x,\y) circle (2pt);}
		...
		\draw[<->,ultra thick,color=red,dashed] (b5) -- (b5n);
		\draw[<->,ultra thick,color=red,dashed] (b4n) -- (b5n);
	\end{scope}
	\begin{scope}[xshift=3.25cm,yshift=4.25cm]
		...
		\draw[<->,ultra thick,dotted] (b3n) -- (b4n);
	\end{scope}
